...
public class T10Drag :MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
  ...
  [HideInInspector] public RectTransform rectTransform;
    ...
    // public Transform onDragTransform;
    ...
    {
       // transform.SetParent(onDragTransform);
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        if (!isDropped)
        {
            ...
            //  transform.SetParent(backToInitial);
          //  ReturnToOriginalPos();
